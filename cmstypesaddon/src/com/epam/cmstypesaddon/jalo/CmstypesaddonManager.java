 ...
 */
package com.epam.cmstypesaddon.jalo;
...
import com.epam.cmstypesaddon.constants.CmstypesaddonConstants;



/**
 * This is the extension manager of the Cmstypesaddon extension.
 */
public class CmstypesaddonManager extends GeneratedCmstypesaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CmstypesaddonManager.class.getName());
	 ...
	 */
	public static CmstypesaddonManager getInstance()
	{
		return (CmstypesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CmstypesaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CmstypesaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CmstypesaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CmstypesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CmstypesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
