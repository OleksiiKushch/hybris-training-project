 ...
 */
package org.trainingbackofficeext.jalo;
...
import org.trainingbackofficeext.constants.TrainingbackofficeextConstants;
 ...
 */
public class TrainingbackofficeextManager extends GeneratedTrainingbackofficeextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingbackofficeextManager.class.getName());
	 ...
	 */
	public static TrainingbackofficeextManager getInstance()
	{
		return (TrainingbackofficeextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingbackofficeextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingbackofficeextManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingbackofficeextManager called.");
		}
	}
