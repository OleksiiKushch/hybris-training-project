 ...
 */
package com.myapp.trainingaddonext.jalo;
...
import com.myapp.trainingaddonext.constants.TrainingaddonextConstants;



/**
 * This is the extension manager of the Trainingaddonext extension.
 */
public class TrainingaddonextManager extends GeneratedTrainingaddonextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingaddonextManager.class.getName());
	 ...
	 */
	public static TrainingaddonextManager getInstance()
	{
		return (TrainingaddonextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingaddonextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingaddonextManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingaddonextManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingaddonextManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingaddonextManager called, current tenant: " + getTenant().getTenantID());
		}
	}
