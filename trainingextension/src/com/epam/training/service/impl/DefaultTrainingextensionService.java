...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingextensionService.class);
	...
	{
		return DefaultTrainingextensionService.class.getResourceAsStream("/trainingextension/sap-hybris-platform.png");
	}
