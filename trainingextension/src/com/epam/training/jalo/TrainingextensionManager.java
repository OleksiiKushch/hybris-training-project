...
/**
 * This is the extension manager of the Trainingextension extension.
 */
public class TrainingextensionManager extends GeneratedTrainingextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TrainingextensionManager.class);
	 ...
	 */
	public static TrainingextensionManager getInstance()
	{
		return (TrainingextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingextensionManager() // NOPMD 
	{
		LOG.debug("constructor of TrainingextensionManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TrainingextensionManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TrainingextensionManager called, current tenant: {}", getTenant().getTenantID());
	}
